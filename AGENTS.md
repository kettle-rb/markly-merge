...
```bash
mise trust -C /home/pboling/src/kettle-rb/markly-merge
mise exec -C /home/pboling/src/kettle-rb/markly-merge -- bundle exec rspec
```
...
✅ **CORRECT**:
```bash
eval "$(mise env -C /home/pboling/src/kettle-rb/markly-merge -s bash)" && bundle exec rspec
```

❌ **WRONG**:
```bash
cd /home/pboling/src/kettle-rb/markly-merge
bundle exec rspec
```

❌ **WRONG**:
```bash
cd /home/pboling/src/kettle-rb/markly-merge && bundle exec rspec
```
...
mise exec -C /home/pboling/src/kettle-rb/markly-merge -- env K_SOUP_COV_MIN_HARD=false bundle exec rspec spec/markly/merge/smart_merger_spec.rb

# Markly backend tests
mise exec -C /home/pboling/src/kettle-rb/markly-merge -- bundle exec rspec --tag markly
```

### Coverage Reports

```bash
mise exec -C /home/pboling/src/kettle-rb/markly-merge -- bin/rake coverage
mise exec -C /home/pboling/src/kettle-rb/markly-merge -- bin/kettle-soup-cover -d
```
