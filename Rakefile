...
# markly-merge Rakefile v1.0.0 - 2026-04-03
...
# rake install                                # Build and install markly-merge-1.0.0.gem in...
# rake install:local                          # Build and install markly-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install markly-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template markly-merge against itse...
# rake kettle:jem:template                    # Template markly-merge files into the curren...
