...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/markly/merge/version.rb", mod) }::Markly::Merge::Version::VERSION
  else
    ...
    require "markly/merge/version"
    Markly::Merge::Version::VERSION
  end
